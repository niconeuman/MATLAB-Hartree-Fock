function [VL1L2_N,VL1L2_Np1,bufferInts] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1,L2,Lmax,order,Boys_Table,bufferInts)
...
elseif (L1 > 0 && L2 == 0)
    ...
    [VL1m1L2_N,VL1m1L2_Np1] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1-1,L2,Lmax,order,Boys_Table,bufferInts);
    [~,VL1m1L2_Np2] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1-1,L2,Lmax,order+1,Boys_Table,bufferInts);
    switch L1-2
        case -1
        ...
        case 0
            [VL1m2L2_N,VL1m2L2_Np1] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1-2,L2,Lmax,order,Boys_Table,bufferInts);
        ...
        %[ds]
            ...
            VL1L2_N = [RPA(1)*VL1m1L2_N;RPA(2)*VL1m1L2_N(end-L1+1:end);RPA(3)*VL1m1L2_N(end)]...
                        -[RPC(1)*VL1m1L2_Np1;RPC(2)*VL1m1L2_Np1(end-L1+1:end);RPC(3)*VL1m1L2_Np1(end)]...
                        +1/2/p*(L1-1)*([VL1m2L2_N-VL1m2L2_Np1;VL1m2L2_N(end-L1+1:end)-VL1m2L2_Np1(end-L1+1:end);VL1m2L2_N(end)-VL1m2L2_Np1(end)]);
...
elseif (L1 == 0 && L2 > 0)
    ...
    %This line of integrals will always be a COLUMN vector
    [VL1L2m1_N,VL1L2m1_Np1] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1,L2-1,Lmax,order,Boys_Table,bufferInts);
    [~,VL1L2m1_Np2] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1,L2-1,Lmax,order+1,Boys_Table,bufferInts);
    switch L2-2
        case -1
        ...
        case 0
            [VL1L2m2_N,VL1L2m2_Np1] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1,L2-2,Lmax,order,Boys_Table,bufferInts);
        %The outputs are [ss](m), and the final integral VAB_L1_L2_order =
        %[ds]
            ...
            VL1L2_N = [RPB(1)*VL1L2m1_N,RPB(2)*VL1L2m1_N(end-L2+1:end),RPB(3)*VL1L2m1_N(end)]...
                            -[RPC(1)*VL1L2m1_Np1,RPC(2)*VL1L2m1_Np1(end-L2+1:end),RPC(3)*VL1L2m1_Np1(end)]...
                            +1/2/p*(L2-1)*([VL1L2m2_N-VL1L2m2_Np1,VL1L2m2_N(end-L2+1:end)-VL1L2m2_Np1(end-L2+1:end),VL1L2m2_N(end)-VL1L2m2_Np1(end)]);    
        otherwise
            [VL1L2m2_N,VL1L2m2_Np1] = recursive_electron_nuclear_3(a,b,RPA,RPB,RPC,p,RPC2,Z,L1,L2-2,Lmax,order,Boys_Table,bufferInts);
        %The outputs are [ps](m), and the final integral is [fs] or
        %[ds](m) and the final integrals [gs], etc
