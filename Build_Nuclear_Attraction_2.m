            ...
            for na  = 1:basis_a.n
                ...
                for nb = 1:basis_b.n
                    for N = 1:nAtom    
                        ...
                        RPC2 = (Px-AL(N,1))^2+(Py-AL(N,2))^2+(Pz-AL(N,3))^2;
                    ...
                    order = 0;
                    VAB(mu_begin:mu_end,nu_begin:nu_end) = VAB(mu_begin:mu_end,nu_begin:nu_end) + recursive_electron_nuclear_2(aa,ab,RPA,RPB,RPC,p,RPC2,Z(N),g1.L,g2.L,order,Boys_Table)*c1*c2*N1*N2;
                    end
                end
            end
        end
