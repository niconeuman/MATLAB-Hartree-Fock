function gabcd = ascs_3minimal(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1,L3,order,Boys_Table,nz,unique)
...
elseif L3 == 1 %[ps|ps], [ds|ps], [fs|ps], etc
    ...
    %[[ds|ss],~,~[ps|ss],~] = [6,1,1,1]
    [gLap1SLcm1s,~,~,~] = vrr_1minimal(Kab,Kcd,RPA,RWP,p,q,alpha,RPQ2,L1+1,order,Boys_Table);
