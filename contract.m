function gabcd = contract_ssss(basis_a,basis_b,basis_c,basis_d,Boys_Table)
...
%fun is a function handle. I could use VRR, HRR, etc
    ...
    for na=1:basis_a.n %loops over the number of primitives in the 1st contracted basis function
        ...
        c1 = basis_a.c(na);
        N1 = g1.N;
        temp = zeros(Dim1,Dim2,Dim3,Dim4);
...
%                 RABz = g1.z0-g2.z0;
                ...
                temp2 = zeros(Dim1,Dim2,Dim3,Dim4);
                    ...
                    for nc = 1:basis_c.n; %loop over number of primitives in 3rd contracted basis function 
                        ...
                        temp3 = zeros(Dim1,Dim2,Dim3,Dim4);
...
%                             RCDz = g3.z0-g4.z0;
                            ...
                            RPQ2 = RPQ(1)^2+RPQ(1)^2+RPQ(1)^2;
                            alpha = q*p/(q+p);
                            
                            %gabcd(a,b,c,d) = gabcd(a,b,c,d)+A_AB*A_CD*Boys(0,alpha*RPQ2)*2*pi^2.5/(p*pp*sqrt(p+pp)); 
                            
                            temp3 = temp3 + vrr_1(aa,ab,ac,ad,Kab,Kcd,RAB,RCD,RPA,RPB,RQC,RQD,p,q,RPQ,alpha,RPQ2,L1,L2,L3,L4,Lmax,order,Boys_Table)*c4*N4;
