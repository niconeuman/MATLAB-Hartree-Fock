...
%code above. Keep in mind!!!!!!!!!!!!!!!!
 ...
 output = zeros(n+1,1);
for m = 1:n+1
 output(m) = Boys_Table(index,m)-Boys_Table(index,m+1)*Dx+Boys_Table(index,m+2)*half_Dx2...
        -Boys_Table(index,m+3)*sixth_Dx3+Boys_Table(index,m+4)*twenty_fourth_Dx4-Boys_Table(index,m+5)*hundred_twentieth_Dx5...
