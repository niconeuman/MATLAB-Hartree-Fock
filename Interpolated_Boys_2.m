function output = Interpolated_Boys_2(x,Boys_Table)
...
output = Boys_Table(index,1)-Boys_Table(index,2)*Dx+Boys_Table(index,3)*half_Dx2...
        -Boys_Table(index,4)*sixth_Dx3+Boys_Table(index,5)*twenty_fourth_Dx4-Boys_Table(index,6)*hundred_twentieth_Dx5...
