function [gascs,gap1scm1s,gam1scm1s,gascm1s,gascm2s] = ascs_4(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1,L3,order,Boys_Table,nz,unique)
...
if L3 == 0
    %disp('Is this used');
    gascs = vrr_1minimal(Kab,Kcd,RPA,RWP,p,q,alpha,RPQ2,L1,order,Boys_Table);
...
elseif L3 == 1 %[ps|ps], [ds|ps], [fs|ps], etc
    ...
    %[gascm1s,~,gam1scm1s,~] = vrr_1minimal(Kab,Kcd,RPA,RWP,p,q,alpha,RPQ2,L1,order,Boys_Table);
    %[[ds|ss],~,~[ps|ss],~] = [6,1,1,1]
    %[gap1scm1s,~,~,~] = vrr_1minimal(Kab,Kcd,RPA,RWP,p,q,alpha,RPQ2,L1+1,order,Boys_Table);
    
    [gap1scm1s,~,gascm1s,~,gam1scm1s] = vrr_1minimal(Kab,Kcd,RPA,RWP,p,q,alpha,RPQ2,L1+1,order,Boys_Table);
    
    %gLap1SLcm1s %[ds|ss], [fs|ss], [gs|ss], etc
    %gLaSLcm1s %[ps|ss], [ds|ss], [fs|ss], etc
    
    term1 = -(p/q)*int_reshape(gap1scm1s,L1+1,L3-1,1,unique); %[ps|ps], [ds|ps], [fs|ps], etc
    term2 = int_expand(gascm1s,(RQC+p/q*RPA),L3-1,2); %[ps|ps], [ds|ps], [fs|ps], etc
    ...
    %term2 = int_expand(gLaSLcm1s,(RQC+alpha/q*RPA),L3-1,2);
        ...
        if L1 == 1 %ssss gLam1SLcm1s
            term3 = 1/2/q*[gam1scm1s 0 0
                           0 gam1scm1s 0
                           0 0 gam1scm1s];
        elseif L1 == 2 %psss gLam1SLcm1s
            term3 = 1/2/q*[2*gam1scm1s(1)   0                 0
                           gam1scm1s(2)     gam1scm1s(1)      0
                           gam1scm1s(3)     0                 gam1scm1s(1)
                           0                2*gam1scm1s(2)    0
                           0                gam1scm1s(3)      gam1scm1s(2)
                           0                0                 2*gam1scm1s(3)];            
         elseif L1 == 3 %dsss gLam1SLcm1s
             term3 = 1/2/q*[3*gam1scm1s(1)      0                 0
                            2*gam1scm1s(2)      1*gam1scm1s(1)    0
                            2*gam1scm1s(3)      0                 1*gam1scm1s(1)
                            1*gam1scm1s(4)      2*gam1scm1s(2)    0
                            1*gam1scm1s(5)      1*gam1scm1s(3)    1*gam1scm1s(2)
                            1*gam1scm1s(6)      0                 2*gam1scm1s(3)
                            0                   3*gam1scm1s(4)    0
                            0                   2*gam1scm1s(5)    1*gam1scm1s(4)
                            0                   1*gam1scm1s(6)    2*gam1scm1s(5)
                            0                   0                 3*gam1scm1s(6)];                
        end

    gascs = term1 + term2 + term3;
    gascm2s = [];
...
%     gam1scm1s = ascs_3minimal(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1-1,L3-1,order,Boys_Table,nz,unique);
...
%     gascm2s = ascs_3minimal(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1,L3-2,order,Boys_Table,nz,unique);
...
%     gascm1s = ascs_3minimal(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1,L3-1,order,Boys_Table,nz,unique);
...
%     gap1scm1s = ascs_3minimal(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1+1,L3-1,order,Boys_Table,nz,unique);
    
    [gam1scm1s,gascm2s,gam2scm2s,gam1scm2s,gam1scm3s] = ascs_4(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1-1,L3-1,order,Boys_Table,nz,unique);
    [gap1scm1s,gap2scm2s,gascm2s,gap1scm2s,gap1scm3s] = ascs_4(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1+1,L3-1,order,Boys_Table,nz,unique);
    [gascm1s,gap1scm2s,gam1scm2s,gascm2s,gascm3s] = ascs_4(Kab,Kcd,RPA,RQC,RWP,p,q,alpha,RPQ2,L1,L3-1,order,Boys_Table,nz,unique);
