function output = vrrBoys_Table_4(x,Boys_Table)
%Jan 4th 2018
...
output = [Boys_Table(index,1)-Boys_Table(index,2)*Dx+Boys_Table(index,3)*half_Dx2-Boys_Table(index,4)*sixth_Dx3+Boys_Table(index,5)*twenty_fourth_Dx4-Boys_Table(index,6)*hundred_twentieth_Dx5
           ...
           Boys_Table(index,5)-Boys_Table(index,6)*Dx+Boys_Table(index,7)*half_Dx2-Boys_Table(index,8)*sixth_Dx3+Boys_Table(index,9)*twenty_fourth_Dx4-Boys_Table(index,10)*hundred_twentieth_Dx5];
